    ...
    return (
        <div>
            ...
            <form id="pizza-form" onSubmit={handleSubmit}>
                ...
                <div>Size:<select id="size-dropdown" onChange={e => setSize(e.target.value)} value={size}>
                ...
                <div>Ham: <input type="checkbox" name="name" onChange={e => setTopping3(e.target.checked)} value={topping3} /></div>
                <div>Pineapple: <input type="checkbox" name="name" onChange={e => setTopping4(e.target.checked)} value={topping4} /></div>
                <div>Special: <input id="special-text" type="text" name="name" onChange={e => setSpecial(e.target.value)} value={special} /></div>
